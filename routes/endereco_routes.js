...
// POST /endereco: para cadastrar um novo endereço.
// GET /endereco: para listar todos os endereços.
// GET /endereco/:id: para buscar um endereço específico pelo ID.
// PUT /endereco/:id: para atualizar as informações de um endereço específico pelo ID.
// DELETE /endereco/:id: para excluir um endereço específico pelo ID.
...
const enderecoRoutes = require("../routes/endereco_routes.js");
